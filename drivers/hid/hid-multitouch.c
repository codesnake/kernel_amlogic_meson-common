...
static const struct hid_device_id mt_devices[] = {
	...
	{ .driver_data = MT_CLS_DUAL_INRANGE_CONTACTID,
		HID_USB_DEVICE(USB_VENDOR_ID_IRTOUCHSYSTEMS,
			USB_DEVICE_ID_IRTOUCH_INFRARED_USB1) },
	{ .driver_data = MT_CLS_DUAL_INRANGE_CONTACTID,
		HID_USB_DEVICE(USB_VENDOR_ID_IRTOUCHSYSTEMS,
			USB_DEVICE_ID_IRTOUCH_INFRARED_USB2) },
	...
	/* RNDPLUS panels */ 
	{ .driver_data = MT_CLS_DEFAULT, 
		HID_USB_DEVICE(USB_VENDOR_ID_RNDPLUS,
			USB_DEVICE_ID_RNDPLUS_PULSEIR1) }, 
	{.driver_data=MT_CLS_DEFAULT,   
		HID_USB_DEVICE(USB_VENDOR_ID_RNDPLUS,
			USB_DEVICE_ID_RNDPLUS_PULSEIR2) }, 
	{.driver_data= MT_CLS_DEFAULT,   
		HID_USB_DEVICE(USB_VENDOR_ID_RNDPLUS, 
			USB_DEVICE_ID_RNDPLUS_PULSEIR3) },

	/* Sotouch panels */
	{ .driver_data = MT_CLS_DEFAULT,
		HID_USB_DEVICE(USB_VENDOR_ID_SOTOUCH,
			USB_DEVICE_ID_SOTOUCH_SCREEN) },
